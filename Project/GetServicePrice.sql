...
Begin
	...
	(
		Select Sum(ServiceType.Price * (1 + Hotel.Star / 10) * (1 + (Case When ServiceRoom.LuxDegree Is Null Then 0 Else ServiceRoom.LuxDegree End) / 10))
		From [Order].Booking
		...
		Left Join [Catalog].Room ServiceRoom On ServiceRoom.RoomId = [Service].RoomId
